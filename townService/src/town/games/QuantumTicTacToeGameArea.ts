...
export default class QuantumTicTacToeGameArea extends GameArea<QuantumTicTacToeGame> {
  ...
  public handleCommand<CommandType extends InteractableCommand>(
    ...
    // Copied from TicTacToeGameArea with some minor modifications to support QuantumTicTacToe
    if (command.type === 'GameMove') {
      const game = this._game;
      // for some reason the command.move wasn't being interpreted as a QuantumTicTacToeMove,
      // so we typed it
